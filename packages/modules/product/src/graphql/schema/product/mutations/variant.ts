...
export function registerVariantMutations(builder: ProductGraphQLSchemaBuilder): void {
  ...
  builder.relayMutationField(
    ...
    },
    {
      ...
      errors: { types: [VariantNotFound, SkuTaken, DuplicateVariantMatrix] },
    ...
    { outputFields: t => ({ variant: t.field({ type: 'ProductVariant', resolve: p => p.variant, description: 'The newly created variant.' }) }) },
  )
  ...
  builder.relayMutationField(
    ...
    },
    {
      ...
      errors: { types: [VariantNotFound, OptimisticLockError] },
      authScopes: async (_parent, args, ctx) => {
    ...
    { outputFields: t => ({ variant: t.field({ type: 'ProductVariant', resolve: p => p.variant, description: 'The updated variant.' }) }) },
  )
  ...
  builder.relayMutationField(
    ...
    { outputFields: t => ({ variant: t.field({ type: 'ProductVariant', resolve: p => p.variant, description: 'The soft-deleted variant.' }) }) },
  )
}
