...
/**
 * Resolve a channel's organization id from its numeric id, so a by-id field
 * can authorize against the owning org via auth's `permission` scope.
 ...
 * deferring to the resolver/service `ChannelNotFound` (404) rather than
