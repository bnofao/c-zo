...
// Alias `@czo/channel/*`, `@czo/stock-location/*`, and `@czo/auth/*` to local
...
export default defineConfig({
  resolve: {
    alias: {
      '@czo/channel/services': resolve(__dirname, 'src/services/index.ts'),
      '@czo/channel/graphql': resolve(__dirname, 'src/graphql/index.ts'),
      '@czo/channel/schema': resolve(__dirname, 'src/database/schema.ts'),
      '@czo/channel/relations': resolve(__dirname, 'src/database/relations.ts'),
