...
// export function createUserService_(auth: Auth): UserService {
...
class UserRepository extends Repository<{ users: UserSchema }, Relations, UserSchema, 'users'> {
  get model() {
...
export const createUserService = (db: Database) => UserRepository.buildService([db])
