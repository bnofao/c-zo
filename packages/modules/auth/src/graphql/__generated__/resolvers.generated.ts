...
import    { DateTimeResolver,EmailAddressResolver } from 'graphql-scalars';
    export const resolvers: Resolvers = {
      Query: { _empty: Query__empty,checkSlug: Query_checkSlug,invitation: Query_invitation,invitations: Query_invitations,members: Query_members,myApiKeys: Query_myApiKeys,myAuthConfig: Query_myAuthConfig,organization: Query_organization,organizations: Query_organizations,user: Query_user,userSessions: Query_userSessions,users: Query_users },
      Mutation: { _empty: Mutation__empty,acceptInvitation: Mutation_acceptInvitation,banUser: Mutation_banUser,cancelInvitation: Mutation_cancelInvitation,createOrganization: Mutation_createOrganization,createUser: Mutation_createUser,deleteOrganization: Mutation_deleteOrganization,impersonateUser: Mutation_impersonateUser,inviteMember: Mutation_inviteMember,rejectInvitation: Mutation_rejectInvitation,removeMember: Mutation_removeMember,removeUser: Mutation_removeUser,revokeSession: Mutation_revokeSession,revokeSessions: Mutation_revokeSessions,setActiveOrganization: Mutation_setActiveOrganization,setRole: Mutation_setRole,stopImpersonation: Mutation_stopImpersonation,unbanUser: Mutation_unbanUser,updateMemberRole: Mutation_updateMemberRole,updateOrganization: Mutation_updateOrganization,updateUser: Mutation_updateUser },
