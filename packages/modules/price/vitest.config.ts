...
// Alias `@czo/price/*` and `@czo/auth/*` to local `src/` rather than each
...
export default defineConfig({
  resolve: {
    alias: {
      '@czo/price/services': resolve(__dirname, 'src/services/index.ts'),
      '@czo/price/graphql': resolve(__dirname, 'src/graphql/index.ts'),
      '@czo/price/schema': resolve(__dirname, 'src/database/schema.ts'),
      '@czo/price/relations': resolve(__dirname, 'src/database/relations.ts'),
