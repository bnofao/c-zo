...
- [ ] No code duplication (shared logic in packages/)

### ✓ II. Testing Standards (NON-NEGOTIABLE)
- [ ] TDD approach documented in tasks
- [ ] Unit tests for business logic
- [ ] Integration tests for API endpoints
- [ ] Contract tests for public package APIs
- [ ] E2E tests for critical user journeys

### ✓ III. API-First Architecture
- [ ] All APIs documented in spec (type, schema, auth, rate limits)
- [ ] GraphQL or REST contracts defined
- [ ] Versioning strategy specified
- [ ] Error handling defined

### ✓ IV. Modular Design
- [ ] Feature belongs in appropriate package or app
- [ ] No circular dependencies introduced
- [ ] Inter-package dependencies explicit
- [ ] Single, clear purpose

### ✓ V. UX Consistency
- [ ] Uses shared UI component library (packages/ui)
...
- [ ] API response time targets defined (P50, P95, P99)
- [ ] Frontend performance metrics specified (FCP, TTI, LCP)
- [ ] Bundle size constraints documented
...
- [ ] Key metrics identified (RED + business metrics)
